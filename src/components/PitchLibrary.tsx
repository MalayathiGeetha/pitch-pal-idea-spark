...
const PitchLibrary = () => {
  ...
  const [editedStructure, setEditedStructure] = useState<{title: string; content: string}[]>([]);
  ...
  const loadPitches = () => {
    ...
    setPitches(savedPitches.sort((a: SavedPitch, b: SavedPitch) => 
  ...
  const saveEdits = () => {
    ...
    const updatedPitches = pitches.map(pitch => 
      pitch.id === editingPitch.id 
        ? { ...pitch, oneLiner: editedOneLiner, pitchStructure: editedStructure }
        : pitch
    );
    ...
    <div className="p-8 max-w-6xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-400">
          {pitches.length === 0 
            ? "No pitches saved yet. Create your first pitch to get started!" 
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="grid gap-3">
                      {pitch.pitchStructure.slice(0, 3).map((section, index) => (
